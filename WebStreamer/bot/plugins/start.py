    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL is not None:
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="Something went Wrong. Contact my [Support Group](https://naija_bestz).",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton('Editor', url='https://t.me/Davoe-D')]
                ]
            ),
            disable_web_page_preview=True
        )
...
async def help_handler(bot, message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Support Group", url="https://naija_bestz"), InlineKeyboardButton("Bots Channel", url="https://t.me/BestzBotUpdate")],
